...
function buildAiMessages(string $action, string $text, ?string $customPrompt = null, array $options = []): array {
    ...
    $prompts = [
        'improve' => 'Improve the following note text for clarity and readability. Preserve the meaning and tone. Return only the improved text without commentary.',
        'grammar' => 'Fix grammar, spelling, and punctuation in the following text. Return only the corrected text without commentary.',
        'shorter' => 'Make the following text shorter while keeping the key points. Return only the shortened text without commentary.',
        'expand' => 'Expand and elaborate on the following note text with useful detail, examples, and context where appropriate. Keep the same topic and voice. Return only the expanded text without commentary.',
        'formal' => 'Rewrite the following text in a professional, formal tone. Return only the rewritten text without commentary.',
        'casual' => 'Rewrite the following text in a friendly, conversational tone. Return only the rewritten text without commentary.',
        ...
        'outline' => 'Create a structured outline of the following note using numbered sections and sub-points. Return only the outline without commentary.',
        'explain' => 'Explain the following note in simple, easy-to-understand language as if teaching someone new to the topic. Use short paragraphs. Return only the explanation without commentary.',
        ...
        'translate' => 'Translate the following text into ' . $targetLang . '. Preserve meaning and tone. Return only the translated text without commentary.',
        'continue' => 'Continue writing naturally from the following note text. Match the style and topic. Return only the continuation without commentary.',
        'generate' => 'Write a well-structured note about the following topic. Use clear headings, paragraphs, and bullet lists where helpful. Return only the note content without commentary.',
        'brainstorm' => 'Brainstorm creative ideas, angles, and talking points related to the following topic. Return a numbered list of ideas without commentary.',
        ...
        'quiz' => 'Create a short study quiz from the following note with 5–8 questions. Include multiple-choice options where useful, then provide an "Answer key" section at the end. Return only the quiz without commentary.',
        'memorize' => 'Suggest practical memory techniques, mnemonics, and recall strategies to help memorize the following material. Return only the tips without commentary.',
        'study_plan' => 'Create a practical study plan to learn and retain the material in the following note. Break it into sessions with goals and review steps. Return only the plan without commentary.',
        ...
        'ask' => 'Answer the user question using only information from the note below. If the note does not contain enough information, say so briefly and suggest what to add. Return only the answer without commentary.',
        'summarize_section' => 'Summarize the collection of notes below from the subfolder "' . $scopeLabel . '". Highlight themes, key facts, and how the notes relate. Return only the summary without commentary.',
        'summarize_notebook' => 'Summarize the collection of notes below from the folder "' . $scopeLabel . '". Highlight themes, key facts, and an overview of what is covered. Return only the summary without commentary.',
    ];
